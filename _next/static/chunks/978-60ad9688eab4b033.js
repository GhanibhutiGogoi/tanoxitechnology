...
to {
  ...
  animation: ${V} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,M=({toast:e})=>{let{icon:r,type:n,iconTheme:c}=e;return void 0!==r?"string"==typeof r?m.createElement(Z,null,r):r:"blank"===n?null:m.createElement(Q,null,m.createElement(z,{...c}),"loading"!==n&&m.createElement(G,null,"error"===n?m.createElement(F,{...c}):m.createElement(R,{...c})))},ye=e=>`
...
`,Ae=(e,r)=>{let n=e.includes("top")?1:-1,[c,l]=A()?["0%{opacity:0;} 100%{opacity:1;}","0%{opacity:1;} 100%{opacity:0;}"]:[ye(n),ge(n)];return{animation:r?`${P(c)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${P(l)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},ei=m.memo(({toast:e,position:r,style:n,children:c})=>{let l=e.height?Ae(e.position||r||"top-center",e.visible):{opacity:0},d=m.createElement(M,{toast:e}),f=m.createElement(et,{...e.ariaProps},dist_f(e.message,e));return m.createElement(Y,{className:e.className,style:{...l,...n,...e.style}},"function"==typeof c?c({icon:d,message:f}):m.createElement(m.Fragment,null,d,f))});d=m.createElement,o.p=void 0,b=d,w=void 0,C=void 0;var ve=({id:e,className:r,style:n,onHeightUpdate:c,children:l})=>{let d=m.useCallback(r=>{if(r){let i=()=>{c(e,r.getBoundingClientRect().height)};i(),new MutationObserver(i).observe(r,{subtree:!0,childList:!0,characterData:!0})}},[e,c]);return m.createElement("div",{ref:d,className:r,style:n},l)},Ee=(e,r)=>{let n=e.includes("top"),c=e.includes("center")?{justifyContent:"center"}:e.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:A()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${r*(n?1:-1)}px)`,...n?{top:0}:{bottom:0},...c}},eo=u`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,Oe=({reverseOrder:e,position:r="top-center",toastOptions:n,gutter:c,children:l,containerStyle:d,containerClassName:f})=>{let{toasts:g,handlers:h}=O(n);return m.createElement("div",{id:"_rht_toaster",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...d},className:f,onMouseEnter:h.startPause,onMouseLeave:h.endPause},g.map(n=>{let d=n.position||r,f=Ee(d,h.calculateOffset(n,{reverseOrder:e,gutter:c,defaultPosition:r}));return m.createElement(ve,{id:n.id,key:n.id,onHeightUpdate:h.updateHeight,className:n.visible?eo:"",style:f},"custom"===n.type?dist_f(n.message,n):l?l(n):m.createElement(ei,{toast:n,position:d}))}))}}}]);